#!/bin/bash
# Script to rebuild hero3.html with full inlined SVG content

set -e

HTML_FILE="hero3.html"
TEMP_HTML="/tmp/hero3_new.html"
...
# Create header section (everything before first SVG - adjust line number as needed)
sed -n '1,102p' "${HTML_FILE}" > "${TEMP_HTML}"
